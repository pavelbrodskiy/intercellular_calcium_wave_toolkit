function [medianStruct, metadata] = projectControls(category, structMaps, size)
%% Parse Inputs (lazy)
cutoffs = (13:2:21)*1e3; % array for cutoff values for pouch size
catControl = categorical({'control'});
...
isControl = category == catControl; % Indices of control discs
